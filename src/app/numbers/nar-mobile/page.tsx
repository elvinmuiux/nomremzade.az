...
export default function NarMobilePage() {
  ...
  useEffect(() => {
    const loadNumbers = async () => {
      try {
        // Load Nar Mobile JSON files from public/data
        const dataFiles = [
      ...
      <PageTemplate showTopNav={false}>
        <div className="numbers-container">
          <div className="empty-state">
            <div>Nar Mobile nömrələri yüklənir...</div>
          </div>
        </div>
      </PageTemplate>
    );
  ...
  return (
    <PageTemplate showTopNav={false}>
      <div className="numbers-container">
        <h1 className="numbers-title">Nar Mobile nömrələri</h1>
            ...
            {isSearching && !hasSearchResults ? (
              ...
              <div className="empty-state">
                {searchTerm ? (
                  ...
                  <p className="empty-title">Hal-hazırda mövcud Nar Mobile nömrəsi yoxdur</p>
                )}
