...
export default function NaxtelPage() {
  ...
  useEffect(() => {
    const loadNumbers = async () => {
      try {
        // Load Naxtel JSON files from public/data
        const dataFiles = [
      ...
      <PageTemplate showTopNav={false}>
        <div className="numbers-container">
          <div className="empty-state">
            <div>Naxtel nömrələri yüklənir...</div>
          </div>
        </div>
      </PageTemplate>
    );
  ...
  return (
    <PageTemplate showTopNav={false}>
      <div className="numbers-container">
        <h1 className="numbers-title">Naxtel nömrələri</h1>
            ...
            {isSearching && !hasSearchResults ? (
              ...
              <div className="empty-state">
                {searchTerm ? (
                  ...
                  <p className="empty-title">Hal-hazırda mövcud Naxtel nömrəsi yoxdur</p>
                )}
