...
export default function AzercellPage() {
  ...
  useEffect(() => {
    const loadNumbers = async () => {
      try {
        // Load Azercell JSON files from public/data
        const dataFiles = [
      ...
      <PageTemplate showTopNav={false}>
        <div className="numbers-container">
          <div className="empty-state">
            <div>Azercell nömrələri yüklənir...</div>
          </div>
        </div>
      </PageTemplate>
    );
  ...
  return (
    <PageTemplate showTopNav={false}>
      <div className="numbers-container">
        <h1 className="numbers-title">Azercell nömrələri</h1>
            ...
            {isSearching && !hasSearchResults ? (
              ...
              <div className="empty-state">
                {searchTerm ? (
                  ...
                  <p className="empty-title">Hal-hazırda mövcud Azercell nömrəsi yoxdur</p>
                )}
